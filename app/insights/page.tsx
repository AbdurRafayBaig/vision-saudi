  ...
  return (
    <div className="bg-slate-50 dark:bg-[#0A0D0C] text-slate-900 dark:text-white overflow-x-hidden min-h-screen transition-colors duration-300">
      ...
      <PageHero
        ...
        imageSrc="/images/insights-header.png"
        ...
        customVisual={
          <div className="bg-white dark:bg-white/[0.03] text-slate-900 dark:text-white p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-white/10 shadow-2xl space-y-6 backdrop-blur-2xl relative group hover-green-box transition-all duration-500">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-4">
              <span className="text-xs font-mono text-slate-500 dark:text-[#D8CCB8] uppercase tracking-wider">EDITORIAL PUBLICATION</span>
            ...
            <div className="space-y-3">
              <div className="p-4 bg-slate-50 dark:bg-white/[0.03] border-l-4 border-[#10E784] rounded-2xl">
                <span className="text-[10px] text-[#10E784] font-mono uppercase font-bold block mb-1">LEAD ANALYSIS</span>
                <div className="text-xs font-bold text-slate-900 dark:text-white leading-snug">ISIC 4 Foreign Ownership & MISA License Regulations</div>
              </div>

              <div className="p-4 bg-slate-50 dark:bg-white/[0.03] border-l-4 border-[#10E784] rounded-2xl">
                <span className="text-[10px] text-[#10E784] font-mono uppercase font-bold block mb-1">REAL ESTATE BRIEF</span>
                <div className="text-xs font-bold text-slate-900 dark:text-white leading-snug">Riyadh Commercial Office Yields & REGA Rules</div>
              </div>
            </div>
      ...
      {featuredArticle && (
        <section className="py-[var(--space-section)] bg-white dark:bg-[#101312] border-b border-slate-200 dark:border-white/10 transition-colors duration-300">
          <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
            <div className="p-8 sm:p-12 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-3xl shadow-xl relative overflow-hidden group hover:border-[#10E784]/60 transition-all duration-300 backdrop-blur-xl">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                <div className="lg:col-span-7">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-xs font-mono font-bold text-[#10E784] tracking-widest uppercase px-3.5 py-1 bg-[#10E784]/10 border border-[#10E784]/30 rounded-full">
                      FEATURED ANALYSIS
                    </span>
                    <span className="text-xs font-medium text-slate-500 dark:text-[#B9B3A8] inline-flex items-center gap-1">
                      <Clock className="h-3.5 w-3.5 text-[#10E784]" />
                      {featuredArticle.readTime}
                    </span>
                  </div>

                  <h2 className="font-display text-3xl sm:text-4xl text-slate-900 dark:text-white font-bold mb-4 leading-tight group-hover:text-[#10E784] transition-colors">
                ...
                <div className="lg:col-span-5 relative">
                  <div className="relative aspect-[16/10] overflow-hidden rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg">
                    <Image
      ...
      <section className="py-[var(--space-section-lg)] bg-slate-50 dark:bg-[#0A0D0C] transition-colors duration-300">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filteredArticles.map((article, idx) => (
              <motion.div
                ...
                className="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-[#10E784]/60 transition-all duration-300 shadow-lg group backdrop-blur-xl"
              >
                <div>
                  ...
                  <h3 className="font-display text-2xl text-slate-900 dark:text-white font-bold mb-3 group-hover:text-[#10E784] transition-colors">
                    {article.title}
                  </h3>

                  <p className="text-slate-600 dark:text-[#B9B3A8] text-sm font-light leading-relaxed mb-6">
                    {article.excerpt}
                  </p>
                </div>
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-between w-full pt-4 border-t border-slate-200 dark:border-white/10 text-xs font-mono font-bold uppercase tracking-wider text-[#10E784] group-hover:text-slate-900 dark:group-hover:text-white transition-colors"
                >
