  ...
  return (
    <section className="relative min-h-[92vh] lg:min-h-screen flex flex-col justify-between bg-slate-50 dark:bg-[#0A0D0C] overflow-hidden pt-28 pb-12 md:pb-16 text-slate-900 dark:text-white transition-colors duration-400">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-90 dark:opacity-95 z-0">
          <Image
            src="/images/aboutHeritagePage.png"
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-slate-50/40 via-transparent to-slate-50 dark:from-[#0A0D0C]/40 dark:via-transparent dark:to-[#0A0D0C] z-0" />
      </div>
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 lg:px-8 w-full my-auto py-8">
        <div className="max-w-3xl">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-6 text-slate-900 dark:text-white flex flex-wrap items-baseline gap-x-3 sm:gap-x-4">
            ...
            <p className="text-slate-600 dark:text-[#94A3B8] text-base sm:text-lg leading-relaxed max-w-xl mb-10 font-light">
