    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 sm:p-6 lg:p-10">
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl bg-[#0E1211] border border-white/15 rounded-3xl shadow-2xl overflow-hidden z-10 my-auto text-white transition-colors duration-300"
        >
          {/* Header Bar */}
              ...
              <div className="lg:col-span-5 flex flex-col gap-6">
                ...
                {showYieldCalculator && (
                  <motion.div
                    ...
                    className="bg-[#161B1A] border border-[#10E784]/40 rounded-2xl p-5 space-y-3 shadow-md"
                  >
