...
const partnerLogos = [
  {
    ...
    arabic: "أمانة منطقة الرياض",
    svg: (
      <svg viewBox="0 0 200 60" className="h-10 w-auto fill-current">
        ...
        <text x="55" y="28" fontSize="13" fontWeight="bold" fill="currentColor" fontFamily="sans-serif">أمانة منطقة الرياض</text>
        <text x="55" y="42" fontSize="9" fill="currentColor" opacity="0.7" fontFamily="sans-serif">RIYADH MUNICIPALITY</text>
      </svg>
    ),
  },
  {
    name: "Ministry of Transport & Logistic Services",
    arabic: "وزارة النقل والخدمات اللوجستية",
    svg: (
      <svg viewBox="0 0 240 60" className="h-10 w-auto fill-current">
        ...
        <text x="55" y="28" fontSize="13" fontWeight="bold" fill="currentColor" fontFamily="sans-serif">وزارة النقل والخدمات اللوجستية</text>
        <text x="55" y="42" fontSize="8" fill="currentColor" opacity="0.7" fontFamily="sans-serif">Ministry of Transport and Logistic Services</text>
      </svg>
    ),
  },
  {
    ...
    arabic: "صلني",
    svg: (
      <svg viewBox="0 0 180 60" className="h-10 w-auto fill-current">
        ...
        <text x="145" y="36" fontSize="18" fontWeight="bold" fill="#10E784">صلني</text>
      </svg>
    ),
  },
  {
    name: "Ministry of Foreign Affairs",
    arabic: "المملكة العربية السعودية - وزارة الخارجية",
    svg: (
      <svg viewBox="0 0 220 60" className="h-10 w-auto fill-current">
        ...
        <text x="58" y="26" fontSize="12" fontWeight="bold" fill="currentColor" fontFamily="sans-serif">المملكة العربية السعودية</text>
        <text x="58" y="40" fontSize="12" fontWeight="bold" fill="#10E784" fontFamily="sans-serif">وزارة الخارجية</text>
      </svg>
    ),
  },
  {
    name: "Al Sulaiman Real Estate",
    arabic: "شركة السليمان العقارية",
    svg: (
      <svg viewBox="0 0 200 60" className="h-10 w-auto fill-current">
        <path d="M20 45 C30 15 45 15 50 45" fill="none" stroke="#10E784" strokeWidth="3" strokeLinecap="round" />
        <text x="60" y="30" fontSize="18" fontWeight="bold" fill="currentColor" fontFamily="serif">السليمان</text>
        <text x="60" y="44" fontSize="9" fill="currentColor" opacity="0.7" fontFamily="sans-serif">شركة السليمان العقارية</text>
      </svg>
    ),
  },
  {
    name: "Ministry of Municipal & Rural Affairs",
    arabic: "وزارة الشؤون البلدية والقروية والإسكان",
    svg: (
      <svg viewBox="0 0 240 60" className="h-10 w-auto fill-current">
        ...
        <text x="55" y="28" fontSize="12" fontWeight="bold" fill="currentColor" fontFamily="sans-serif">وزارة الشؤون البلدية والقروية والإسكان</text>
        <text x="55" y="42" fontSize="8" fill="currentColor" opacity="0.7" fontFamily="sans-serif">Ministry of Municipal Rural Affairs & Housing</text>
      </svg>
    ),
  },
  {
    name: "KAFD",
    arabic: "مركز الملك عبد الله المالي",
    svg: (
      <svg viewBox="0 0 160 60" className="h-10 w-auto fill-current">
    ...
    <section className="bg-slate-900 dark:bg-[#0A0D0C] text-slate-900 dark:text-white py-[var(--space-section-lg)] border-b border-slate-200 dark:border-white/10 relative overflow-hidden transition-colors duration-400">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h2 className="font-display text-4xl sm:text-6xl font-bold tracking-tight mb-4 text-white">
            Strategic <span className="text-[#10E784]">Partnerships</span>
          </h2>
          <p className="text-slate-400 dark:text-[#94A3B8] text-lg sm:text-xl font-light leading-relaxed">
            Empowering Investors through strong local partnerships.
          </p>
        </div>

        {/* ── ROW 1: TOP INFINITE MARQUEE TICKER (Partner Logos & Calligraphy) ── */}
        ...
        <div className="relative overflow-hidden py-4">
          ...
          <div className="animate-marquee-reverse items-center gap-6">
            {[...governmentAuthorities, ...governmentAuthorities, ...governmentAuthorities].map((auth, idx) => (
              <div
                key={idx}
                className="flex flex-col items-center justify-between w-40 h-36 p-4 rounded-2xl bg-white/5 dark:bg-[#101312] border border-white/10 hover:border-[#10E784] hover:shadow-[0_0_25px_rgba(16,231,132,0.25)] transition-all duration-300 shrink-0 group cursor-pointer"
              >
                <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                  {auth.icon}
                </div>
                <div className="text-center">
                  ...
                  <span className="block text-[10px] text-slate-400 dark:text-[#94A3B8] font-mono mt-0.5 truncate max-w-[130px]">
                    {auth.arabic}
                  </span>
                </div>
              </div>
