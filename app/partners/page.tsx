...
import { Globe, Network, CheckCircle2, ShieldCheck, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#0A0D0C] text-slate-900 dark:text-white overflow-x-hidden min-h-screen transition-colors duration-300">
      ...
      <PageHero
        ...
        imageSrc="/images/partners-header.png"
      ...
      <section className="py-[var(--space-section-lg)] bg-slate-50 dark:bg-[#0A0D0C] transition-colors duration-300">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="mb-12">
            <p className="text-[#10E784] text-xs font-mono uppercase tracking-widest mb-3 font-bold">
          ...
          {/* Tab Selection */}
          <div className="flex border-b border-slate-200 dark:border-white/10 mb-12 overflow-x-auto">
            <button
              ...
              className={`pb-4 px-6 text-sm font-bold uppercase tracking-wider transition-all duration-300 border-b-2 shrink-0 ${
                activeTab === "service"
                  ...
                  : "border-transparent text-slate-500 dark:text-[#A39B8B] hover:text-slate-900 dark:hover:text-white"
              }`}
            >
          ...
          {activeTab === "service" ? (
            ...
            >
              <div className="lg:col-span-7 bg-white dark:bg-white/[0.03] backdrop-blur-xl border border-slate-200 dark:border-white/10 p-8 sm:p-12 rounded-3xl shadow-xl">
                <div className="inline-flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-widest text-[#10E784] bg-[#10E784]/10 px-3.5 py-1 border border-[#10E784]/30 rounded-full mb-6">
                ...
                <p className="text-slate-600 dark:text-[#A39B8B] text-base font-light leading-relaxed mb-8">
                ...
                <div className="space-y-3 mb-8">
                  <h4 className="text-xs uppercase font-mono tracking-widest text-[#10E784] mb-3 font-bold">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 text-xs text-slate-700 dark:text-[#E2D9C8] p-3.5 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-2xl">
              ...
              <div className="lg:col-span-5 bg-slate-900 dark:bg-[#101312] text-white p-8 sm:p-10 rounded-3xl border border-slate-700 dark:border-white/15 shadow-2xl backdrop-blur-2xl space-y-6">
                <div className="text-xs font-mono font-bold text-[#10E784] uppercase tracking-wider border-b border-white/10 pb-3">
            ...
            >
              <div className="lg:col-span-7 bg-white dark:bg-white/[0.03] backdrop-blur-xl border border-slate-200 dark:border-white/10 p-8 sm:p-12 rounded-3xl shadow-xl">
                ...
                <div className="p-6 bg-slate-900 dark:bg-[#101312] text-white rounded-2xl border border-slate-700 dark:border-white/15 mb-8">
