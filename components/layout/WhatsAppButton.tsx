...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 end-5 sm:bottom-6 sm:end-6 z-50 hidden h-14 w-14 sm:flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.45)] transition-transform hover:scale-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#25D366]"
    >
