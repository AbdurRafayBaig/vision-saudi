...
import { CheckCircle2, ShieldCheck, UserCheck, Briefcase, Award, Home, Calendar } from "lucide-react";
...
export default function PremiumResidencyPage() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#0A0D0C] text-slate-900 dark:text-white transition-colors duration-400 overflow-x-hidden min-h-screen">
      ...
      <section className="py-[var(--space-section)] bg-white dark:bg-[#0A0D0C] transition-colors duration-400">
      ...
      <section id="pathways" className="py-[var(--space-section-lg)] bg-slate-50 dark:bg-[#0A0D0C] border-y border-slate-200 dark:border-white/10 relative overflow-hidden transition-colors duration-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {pathways.map((p, idx) => (
              <motion.div
                ...
                className="bg-white dark:bg-white/[0.03] backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-[#10E784] hover:-translate-y-1 transition-all duration-300 shadow-md dark:shadow-2xl group text-slate-900 dark:text-white"
              >
                <div>
                  ...
                  <span className="text-xs font-mono font-bold text-[#059669] dark:text-[#10E784] uppercase tracking-wider block mb-1">
                    {p.target}
                  </span>
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-white/10">
                  <span className="text-[11px] font-mono font-bold text-[#059669] dark:text-[#10E784] uppercase block mb-1">
                    Key Advantage:
                  </span>
                  <p className="text-xs text-slate-700 dark:text-[#E2D9C8] font-medium leading-relaxed">
                    {p.privilege}
                  </p>
                </div>
              </motion.div>
      ...
      <section className="py-[var(--space-section-lg)] bg-white dark:bg-[#0A0D0C] transition-colors duration-400">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="mb-16">
            <p className="text-[#059669] dark:text-[#10E784] text-xs font-mono uppercase tracking-widest mb-4 font-bold">
              Program Privileges
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-6 bg-slate-50 dark:bg-white/[0.03] backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-2xl flex items-start gap-3 hover:border-[#10E784] transition-all">
                <CheckCircle2 className="h-5 w-5 text-[#059669] dark:text-[#10E784] shrink-0 mt-0.5" />
                <span className="text-xs font-medium text-slate-800 dark:text-[#E2D9C8] leading-relaxed">{benefit}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* FAQ Section */}
      <section className="py-[var(--space-section)] bg-slate-50 dark:bg-[#0A0D0C] border-t border-slate-200 dark:border-white/10 transition-colors duration-400">
